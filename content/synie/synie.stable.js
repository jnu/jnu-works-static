 ...
 *
 * REQUIRES
 * jQuery, jQueryUI, d3, and d3.sankey
 *
 * AUTHOR
...
jn.Chart = function() {
	return {
		...
		baseURL				: 'http://joenoodles.com/widgets/ss/multiget.php',
		singURL				: 'http://joenoodles.com/widgets/ss/synie.php?m=',
		// control
		forceStopped		: false,
		sankeyShowing		: false,
		animationLock		: false,
			...
			var cont = $("<div id='jn-loading-cont'><p><br/>Baking PIE.</p><p>(Clearly you're short on fiber.)</p></div>")
				...
				.append($('<div id="jn-loading"/>')
					.css({
						...
						.append($('<img src="http://joenoodles.com/widgets/img/loadpie.gif" />')));
